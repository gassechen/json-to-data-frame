...
This URL provides a single object that contains a list of all countries.
This is useful for testing that your code can process and flatten arrays
of simple values. URL: \`https://api.first.org/data/v1/countries\`
